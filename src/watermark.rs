...
impl From<MiniWatermark> for String {
    fn from(val: MiniWatermark) -> Self {
        let buffer = match val {
            ...
            MiniWatermark::CrimsonDays => "c23c9ec8709fecad87c26b64f5b2b9f5",
            ...
            MiniWatermark::Warmind => "aaa61f6c70478d87de0df41e5709a773",
            ...
            MiniWatermark::Risen => "b973f89ecd631a3e3d294e98268f7134",
...
impl TryFrom<Option<String>> for MiniWatermark {
    ...
    fn try_from(value: Option<String>) -> Result<Self, Self::Error> {
        ...
        Ok(match &value[31..=62] {
            ...
            "c23c9ec8709fecad87c26b64f5b2b9f5" => MiniWatermark::CrimsonDays,
            ...
            "aaa61f6c70478d87de0df41e5709a773" => MiniWatermark::Warmind,
            ...
            "b973f89ecd631a3e3d294e98268f7134" => MiniWatermark::Risen,
