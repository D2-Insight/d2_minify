...
impl From<MiniWatermark> for String {
    fn from(val: MiniWatermark) -> Self {
        let buffer = match val {
            ...
            MiniWatermark::NewCOO => "2c024f088557ca6cceae1e8030c67169",
        };
        format!(
...
impl TryFrom<Option<String>> for MiniWatermark {
    ...
    fn try_from(value: Option<String>) -> Result<Self, Self::Error> {
        ...
        Ok(match &value[31..=62] {
            ...
            "2c024f088557ca6cceae1e8030c67169" => MiniWatermark::NewCOO,
...
impl MiniWatermark {
    pub fn get_season(&self) -> Option<u8> {
        Some(match self {
            ...
            Self::LightFall => 20,
            Self::Defiance => 20,
            Self::TheDeep | Self::NewForsaken | Self::NewCOO => 21,
            _ => return None,
        })
    }
}
